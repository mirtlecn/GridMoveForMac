...
enum UICopy {
    ...
    static let settingsGeneralInlineTabTitle = "General"
    static let settingsWindowInlineTabTitle = "Window"
    static let settingsTriggerInlineTabTitle = "Trigger"
    ...
    static let settingsWindowHighlightSectionTitle = "Window highlight"
    static let settingsTriggerOverlaySectionTitle = "Trigger overlay"
    ...
    static let settingsShowHighlightTitle = "Show highlight"
    static let settingsShowOverlayTitle = "Show overlay"
    ...
    static let settingsLayoutGapLabel = "Layout gap"
    static let settingsGapLabel = "Gap"
    ...
    static let settingsAddHotkeySheetTitle = "Add hotkey"
    static let settingsAddHotkeySheetMessage = "Choose a behavior and record a shortcut."
