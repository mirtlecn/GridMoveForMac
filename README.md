...
```jsonc
{
  ...
  "appearance": {
    ...
    "layoutGap": 1, // Gap between window layout frames, in points. Shrinks the applied window frame and the overlay highlight by this amount on each side. Missing values default to 1.
